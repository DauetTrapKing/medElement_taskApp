    ...
    messages = [
        {
            ...
            "content": (
                ...
                "2. Отзыв о враче. тут не пиши в третьем лице, это говорит пациент, пиши точно что сказал человек" 
                "3. Оценка клиники (от 1 до 5). "
                "4. Отзыв о клинике. тут не пиши в третьем лице, это говорит пациент, пиши точно что сказал человек"
